...
#ifndef ZXING_ENCODEHINTS_H
#define ZXING_ENCODEHINTS_H
 ...
 */
    ...
    class EncodeHints {
    private:
        std::map<EncodeHintType, std::string> hints;

    public:
        EncodeHints();
        std::string get(EncodeHintType key) const;
        bool containsKey(EncodeHintType key) const;
        void put(EncodeHintType key, const std::string &val);
    };
}


#endif //ZXING_ENCODEHINTS_H
